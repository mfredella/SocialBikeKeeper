...
\- ".php" (per la gestione della persistenza)
...
\- ". gradle" (relativi all\'ambiente di building dell\'IDE di sviluppo)
...
Gli incontri del SCM Team hanno cadenza settimanale e avvengono con la
metodologia SCRUM.
